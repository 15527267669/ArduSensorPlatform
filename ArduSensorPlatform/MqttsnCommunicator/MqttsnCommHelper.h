...
class MqttsnCommHelper :public Pub_SubCommHelperBase
{
public:
	MqttsnCommHelper();
	MqttsnCommHelper(APP_CONFIG appConfig);//配置网络配置和Mqttsn配置；其中mqttsn配置为：ClientId、KeepAlive、KeepAlive、EndDevice、WillTopic、WillMessage的相关信息
	~MqttsnCommHelper();
